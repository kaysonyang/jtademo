...
@EnableJpaRepositories(basePackages = "com.wsjia.jta.repository.order", entityManagerFactoryRef = "orderEntityManager", transactionManagerRef = "transactionManager")
...
public class OrderConfig {
	...
	public LocalContainerEntityManagerFactoryBean orderEntityManager() throws Throwable {
		...
		entityManager.setPackagesToScan("com.wsjia.jta.domain.order");
